...
// MFCScanPort.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCScanPortApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCScanPortApp

CMFCScanPortApp::CMFCScanPortApp()
{
...
// Единственный объект CMFCScanPortApp

CMFCScanPortApp theApp;


// Инициализация CMFCScanPortApp

BOOL CMFCScanPortApp::InitInstance()
{
